...
def capture_all(
    ...
    capture_no_model_dense(view_point, output_image_dir, visualize=visualize)
    capture_model_dense(view_point, output_image_dir, visualize=visualize)
    capture_model_sparse(view_point, output_image_dir, visualize=visualize)
    capture_no_model_sparse(view_point, output_image_dir, visualize=visualize)
